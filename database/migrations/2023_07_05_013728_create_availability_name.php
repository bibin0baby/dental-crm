...
class CreateAvailabilityName extends Migration
{
    ...
    public function up()
    {
        Schema::create('availabilitys', function (Blueprint $table) {
            ...
            $table->string('break_Fromtime')->nullable(); 
            $table->string('break_Totime')->nullable(); 
            $table->string('leave_FromDate')->nullable(); 
            $table->string('leave_ToDate')->nullable(); 
            $table->string('availabilityDays', 25);
            $table->string('availabilityFrom')->nullable(); 
            $table->string('availabilityTo')->nullable(); 
