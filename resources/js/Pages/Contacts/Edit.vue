<template>
  <div>
    ...
    <trashed-message v-if="contact.deleted_at" class="mb-6" @restore="restore"> This Patient has been deleted. </trashed-message>
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        ...
        <div class="flex items-center px-8 py-4 bg-gray-50 border-t border-gray-100">
          <button v-if="!contact.deleted_at" class="text-red-600 hover:underline" tabindex="-1" type="button" @click="destroy">Delete Patient</button>
          <loading-button :loading="form.processing" class="btn-indigo ml-auto" type="submit">Update Patient</loading-button>
        </div>
      </form>
    </div>
  </div>
