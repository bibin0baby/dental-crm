    ...
    <div class="max-w-5xl bg-white rounded-md shadow overflow-hidden">
      ...
      <div class="flex flex-wrap -mb-8 -mr-6 p-8">
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <input type="time" v-model="form.availabilityTo" :error="form.errors.availabilityTo" class="pb-14 pr-14  lg:w-1/05" style="font-weight: 500;">
        ...
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <input type="time" v-model="form.break_Fromtime" :error="form.errors.break_Totime" class="pb-14 pr-14  lg:w-1/05">
          <label class="pb-14 pr-14  lg:w-1/05" style="font-weight: 500;"> To :</label>
          <input type="time" v-model="form.break_Totime" :error="form.errors.break_Totime" class="pb-14 pr-14  lg:w-1/05">
        </div>
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">

          <label class="pb-14 pr-14  lg:w-1/05" style="font-weight: 500;"> Leave</label>
          <label class="pb-14 pr-14  lg:w-1/05" > From:</label>
          <input type="date" v-model="form.leave_FromDate" :error="form.errors.leave_FromDate" class="pb-14 pr-14  lg:w-1/05">
        ...
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <label class="pb-14 pr-14  lg:w-1/05" style="font-weight: 500;">Consultaion Time: </label>
          <select-input v-model="form.ConsultaionTime" :error="form.errors.ConsultaionTime" class="pb-14 pr-14  lg:w-1/05">
