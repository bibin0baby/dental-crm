    ...
    <div class="max-w-5xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="store">
        ...
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          <label class="pb-14 pr-14  lg:w-1/05" style="font-weight: 500;">Consultation</label>
          ...
          <p v-if="form.errors.ConsultationTime" class="text-red-500">{{ form.errors.ConsultationTime }}</p>
