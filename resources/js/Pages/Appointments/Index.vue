<template>
  <div>
    ...
    <h1 class="mb-8 text-3xl font-bold">Appointments</h1>
    <div class="flex items-center justify-between mb-6">
      ...
      <Link class="btn-indigo" href="/appointments/create">
        <span>Create</span>
    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
      ...
      <table class="w-full whitespace-nowrap">
        <tr class="text-left font-bold">
          ...
          <th class="pb-4 pt-6 px-6">Photo</th>
          <th class="pb-4 pt-6 px-6">Doctor Name</th>
          <th class="pb-4 pt-6 px-6">Client Name</th>
        </tr>
